...
%             hold on;
    ...
    if (min_len * 2) < length(time)
        for index = min_len + 1:(length(time) - min_len + 1)
            ...
            cd = 1 - (sum([round((f1 - pf1) .^ 2, 6)  round((f2 - pf2) .^ 2, 6)]) / sum([round((f1 - mean(freq)) .^ 2, 6) round((f2 - mean(freq)) .^ 2, 6)]));
...
%                         hold on;
    ...
    if (min_len * 3) < length(time)
        ...
        for index2 = index1 + min_len:(length(time) - min_len + 1)
            ...
            cd = 1 - (sum([round((f1 - pf1) .^ 2, 6)  round((f2 - pf2) .^ 2, 6)  round((f3 - pf3) .^ 2, 6)]) / sum([round((f1 - mean(freq)) .^ 2, 6) round((f2 - mean(freq)) .^ 2, 6) round((f3 - mean(freq)) .^ 2, 6)]));
