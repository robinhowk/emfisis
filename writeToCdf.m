function writeToCdf( filename, cdfDataMaster, cdfInfoMaster, data, numRecords, ppFilename, fceFilename, timestamp, deltaT )
...
%     varlist{4} = data.timeOffset(1:numRecords, :);
